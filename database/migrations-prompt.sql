...
\n-- Hierarchical categories are data-only on current installs because categories.parent_id already exists.\n-- Use admin/migrate.php to apply the idempotent category catalog and article mapping.\n